...
/* harmony import */ var _modules_spoller_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/spoller.js */ "./js/modules/spoller.js");
/* harmony import */ var _vendor_swiper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendor/swiper.js */ "./js/vendor/swiper.js");
/* harmony import */ var _modules_menu_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/menu.js */ "./js/modules/menu.js");
/* harmony import */ var _modules_popup_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/popup.js */ "./js/modules/popup.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_menu_js__WEBPACK_IMPORTED_MODULE_4__["initMenu"])();
  Object(_vendor_swiper_js__WEBPACK_IMPORTED_MODULE_3__["initSlider"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана

  window.addEventListener('load', function () {
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])();
    Object(_modules_spoller_js__WEBPACK_IMPORTED_MODULE_2__["initSpoller"])();
  });
}); // ---------------------------------
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _popup_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./popup.js */ "./js/modules/popup.js");

var filter = document.querySelector('.filter');
var filterOpenButton = document.querySelector('.filter__show-button');
var filterCloseButton = document.querySelector('.filter__close'); // Закрытие фильтра окна по клику

var onCloseFilterButtonClick = function onCloseFilterButtonClick() {
  filter.classList.add('filter--closed');
  _popup_js__WEBPACK_IMPORTED_MODULE_0__["page"].classList.remove('blocked');
  _popup_js__WEBPACK_IMPORTED_MODULE_0__["popupOverlay"].classList.add('popup-overlay--closed');
}; // Открытие модального окна по клику, добавление основных обработчиков


var onOpenFilterButtonClick = function onOpenFilterButtonClick() {
  filter.classList.remove('filter--closed');
  _popup_js__WEBPACK_IMPORTED_MODULE_0__["page"].classList.add('blocked');
  _popup_js__WEBPACK_IMPORTED_MODULE_0__["popupOverlay"].classList.remove('popup-overlay--closed');
  filterCloseButton.addEventListener('click', onCloseFilterButtonClick, {
    once: true
  });
  window.addEventListener('click', _popup_js__WEBPACK_IMPORTED_MODULE_0__["onOverlayClick"]);
  document.addEventListener('keydown', _popup_js__WEBPACK_IMPORTED_MODULE_0__["onEscPress"], {
    once: true
  });
...
/*!*****************************!*\
  !*** ./js/modules/popup.js ***!
  \*****************************/
/*! exports provided: page, popupOverlay, onOverlayClick, onEscPress */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onOverlayClick", function() { return onOverlayClick; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onEscPress", function() { return onEscPress; });
var page = document.querySelector('.page');
var popup = document.querySelector('.popup');
var popupOpenButton = document.querySelector('.page-header__login');
var popupCloseButton = popup.querySelector('.popup__button');
var popupOverlay = document.querySelector('.popup-overlay');
var popupForm = document.querySelector('.popup-form');
var popupEmailInput = document.getElementById('popup-email'); // Закрытие модального окна по клику
...
var addEmailValue = function addEmailValue() {
...
/***/ "./js/modules/spoller.js":
/*!*******************************!*\
  !*** ./js/modules/spoller.js ***!
  \*******************************/
/*! exports provided: initSpoller */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSpoller", function() { return initSpoller; });
var spollerLabels = document.querySelectorAll('.spoller__button-label');
var spollers = document.querySelectorAll('.spoller__item');

var initSpoller = function initSpoller() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSlider", function() { return initSlider; });
